...
**Key Components**: 1 class(es): BusinessWebsiteScraper, 34 function(s): get_session, __init__, update_global_contacts, clean_text, extract_business_info
...
With over 3 years of experience designing and deploying AI‑powered automation systems across fintech, e‑commerce, and SaaS platforms, I built **business-scraper** as a demonstration of practical, business‑first engineering.
